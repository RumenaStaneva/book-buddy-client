...
const PrivacyPolicy = () => {
    return (
        <>
            ...
            <main class="info-container privacy-policy">
                ...
                <p>We also collect information from mobile devices for a better user experience, although these features are completely optional:</p><ul><li>Photo Gallery (Pictures): Granting photo gallery access allows the user to upload any picture from their photo gallery, you can safely deny photo gallery access for this website.</li>
                </ul>
                ...
                <ul><li>Via Email:  <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="284a4747434a5d4c4c510644414a5a495a5119684f45494144064b4745">[email&#160;protected]</a></li>
                </ul>
            </main>
            <Footer />
        </>
